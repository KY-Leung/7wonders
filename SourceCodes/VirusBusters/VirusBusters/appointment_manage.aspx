<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appointment_manage.aspx.cs" Inherits="VirusBusters.appointment_manage" %>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- BEGIN PAGE LEVEL PLUGINS (TABLE)-->
        ...
        <link href="../public/assets/themes/css/custom.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="../public/assets/themes/img/logo.png" alt="logo" class="logo-default" /> </a>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="m-heading-1 border-green m-bordered">
                       ...
                       <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" DataKeyNames="Id" DataSourceID="SqlDataSource1"  >
                           <Columns>
                               <asp:BoundField DataField="Id" HeaderText="Appointment ID" ReadOnly="True" SortExpression="Id" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:VirusBustersDBConnectionString %>" SelectCommand="SELECT [Id], [clinicName], [date] FROM [appointment]" DeleteCommand="DELETE FROM [appointment] WHERE [Id] = @Id" InsertCommand="INSERT INTO [appointment] ([Id], [clinicName], [date]) VALUES (@Id, @clinicName, @date)" UpdateCommand="UPDATE [appointment] SET [clinicName] = @clinicName, [date] = @date WHERE [Id] = @Id">
                    <DeleteParameters>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="../public/assets/themes/img/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="../public/assets/themes/img/avatar1.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="../public/assets/themes/img/avatar4.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="../public/assets/themes/img/avatar2.jpg" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="../public/assets/themes/img/avatar6.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="../public/assets/themes/img/avatar7.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="../public/assets/themes/img/avatar8.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="../public/assets/themes/img/avatar9.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="../public/assets/themes/img/avatar10.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="../public/assets/themes/img/avatar11.jpg" alt="...">
                                        <div class="media-body">
                            ...
                            <div class="page-quick-sidebar-item">
                                <div class="page-quick-sidebar-chat-user">
                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="../public/assets/themes/img/avatar3.jpg" />
                                            <div class="message">
                                                <span class="arrow"></span>
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="../public/assets/themes/img/avatar2.jpg" />
                                            <div class="message">
                                                <span class="arrow"></span>
